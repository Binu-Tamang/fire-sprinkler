...
<body>
            ...
            <div class="row gy-5 gx-4">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        <img class="img-fluid" src="img/fabrication2.jpg" alt="">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <div class="service-detail">
                            <div class="service-title">
                                <hr class="w-25">
                                <h3 class="mb-0">CNC Bending</h3>
                                <hr class="w-25">
                            </div>
                            <div class="service-text">
                                <p class="text-white mb-0">Star Professional use the latest press brake technologies,
                                    our TRUMPF bending machines along side our highly experienced operators ensures that
                                    our customers products are consistently bent with high accuracy, in the most time
                                    efficient set up.</p>
                            </div>
                        </div>
                        <a class="btn btn-light" href="">Read More</a>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        <img class="img-fluid" src="img/fabrication1.jpg" alt="">
                        <div class="service-img">
                            <img class="img-fluid" src="img/fabrication1.jpg" alt="">
                        </div>
                        <div class="service-detail">
                            <div class="service-title">
                                <hr class="w-25">
                                <h3 class="mb-0">Fabrication</h3>
                                <hr class="w-25">
                            </div>
                            <div class="service-text">
                                <p class="text-white mb-0">Star Professional Fabrication department is filled with
                                    highly skilled Tradesmen that can complete the following processes for you.</p>
                            </div>
                        </div>
                        <a class="btn btn-light" href="">Read More</a>
                    </div>
    ...
    <!-- Project Start -->
    <!-- <div class="container-fluid bg-black pt-5 my-5 px-0">
        ...
        <div class="owl-carousel project-carousel wow fadeIn" data-wow-delay="0.1s">
            <a class="project-item" href="">
                ...
                <div class="project-title">
                    <h5 class="text-primary mb-0">Fabrication</h5>
                </div>
            </a>
            <a class="project-item" href="">
                <img class="img-fluid" src="img/d2.jpeg" alt="">
                <div class="project-title">
                    <h5 class="text-primary mb-0">CNC Bending</h5>
                </div>
            </a>
            <a class="project-item" href="">
                <img class="img-fluid" src="img/fabrication2.jpg" alt="">
